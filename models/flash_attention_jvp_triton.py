...
try:
    ...
    _HAS_FLASH_BWD = False
    def _flash_attn_backward(*args, **kwargs):
        raise RuntimeError("flash_attn package not installed; backward unavailable. "
                           "Only the forward (with JVP) is supported.")
    _flash_attn_varlen_backward = _flash_attn_backward
